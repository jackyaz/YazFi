...
```sh
/usr/sbin/curl -fsL --retry 3 "https://jackyaz.gateway.scarf.sh/YazFi/master/install/YazFi.sh" -o /jffs/scripts/YazFi && chmod 0755 /jffs/scripts/YazFi && /jffs/scripts/YazFi install
```
